...
void display(){
	...
	glBegin(GL_POLYGON);
	 	...
	 	glVertex3f(  -0.8,  0.49, -0.1 );
	 	glVertex3f(  -0.8,  0.49, -0.5 );
	...
	glBegin(GL_POLYGON);
	 	glVertex3f(  0.601,   -0.501, -0.1 );
	 	glVertex3f(  -0.801,  -0.501, -0.1 );
	 	glVertex3f(  -0.801,  0.501, -0.1 );
	 	glVertex3f(  0.601,   0.501, -0.1 );
	glEnd();

	glBegin(GL_POLYGON);
	 	glVertex3f(  0.601, 	-0.501, -0.101 );
	 	glVertex3f(  -0.801,  -0.501, -0.101 );
	 	glVertex3f(  -0.801,  0.501, -0.101 );
	 	glVertex3f(  0.601,   0.001, -0.101 );
	glEnd();
	...
	glBegin(GL_POLYGON);
	 	...
	 	glVertex3f(  -0.8,  0.5, -0.09 );
	 	glVertex3f(  0.6, 	0.5, -0.09 );
	glEnd();

	glBegin(GL_POLYGON);
	 	glVertex3f(  0.6, 	0.49, 0.2 );
	 	glVertex3f(  -0.8,  0.49, 0.2 );
	 	glVertex3f(  -0.8,  0.49, -0.09 );
	...
	glColor3f( 0.87,  0.72, 0.53);
	glBegin(GL_POLYGON);
	 	glVertex3f(  0.601, 	-0.501, 0.2 );
	 	glVertex3f(  -0.801,  -0.501, 0.2 );
	 	glVertex3f(  -0.801,  0.501, 0.2 );
	 	glVertex3f(  0.601,   0.501, 0.2 );
	glEnd();

	glBegin(GL_POLYGON);
	 	glVertex3f(  0.601, 	-0.501, 0.201 );
	 	glVertex3f(  -0.801,  -0.501, 0.201 );
	 	glVertex3f(  -0.801,  0.501, 0.201 );
	 	glVertex3f(  0.601,   0.501, 0.201 );
	glEnd();
	...
	glBegin(GL_POLYGON);
	 	glVertex3f(  0.61, 	-0.51, 0.201 );
	 	glVertex3f(  -0.81,  -0.51, 0.201 );
	 	glVertex3f(  -0.81,  0.51, 0.201 );
	 	glVertex3f(  0.61,   0.51, 0.201 );
	glEnd();

	glBegin(GL_POLYGON);
	 	glVertex3f(  0.61, 	-0.51, 0.21 );
	 	glVertex3f(  -0.81,  -0.51, 0.21 );
	 	glVertex3f(  -0.81,  0.51, 0.21 );
	 	glVertex3f(  0.61,   0.51, 0.21 );
	glEnd();
	...
	//Parede direita - andar 3
  	glColor3f( 0.96,  0.87, 0.7);
	glBegin(GL_POLYGON);
	 	glVertex3f(  0.6, 	0.5, 0.45 );
	 	glVertex3f(  0.3,  0.5, 0.45 );
	 	glVertex3f(  0.3,  0.5, 0.21 );
	 	glVertex3f(  0.6, 	0.5, 0.21 );
	glEnd();

	glBegin(GL_POLYGON);
	 	glVertex3f(  0.6, 	0.49, 0.45 );
	 	glVertex3f(  0.3,  0.49, 0.45 );
	 	glVertex3f(  0.3,  0.49, 0.21 );
	 	glVertex3f(  0.6, 	0.49, 0.21 );
	glEnd();
	...
	glBegin(GL_POLYGON);
	 	glVertex3f(  2.9, -0.5, 0.45);
	 	glVertex3f(  2.9,  0.5, 0.45);
	 	glVertex3f(  2.9,  0.5, 0.21 );
	 	glVertex3f(  2.9,  -0.5, 0.21 );
	glEnd();
	...
	glColor3f( 0.87,  0.72, 0.53);
	glBegin(GL_POLYGON);
	 	glVertex3f(  0.61, 	-0.51, 0.45 );
	 	glVertex3f(  0.28,  -0.51, 0.45 );
	 	glVertex3f(  0.28,  0.51, 0.45 );
	 	glVertex3f(  0.61,   0.51, 0.45 );
	glEnd();

	glBegin(GL_POLYGON);
	 	glVertex3f(  0.61, 	-0.51, 0.46 );
	 	glVertex3f(  0.28,  -0.51, 0.46 );
	 	glVertex3f(  0.28,  0.51, 0.46 );
	 	glVertex3f(  0.61,   0.51, 0.46 );
	glEnd();
	...
	//Parede direita - andar 4 - torre direita
  	glColor3f( 0.96,  0.87, 0.7);
	glBegin(GL_POLYGON);
	 	glVertex3f(  0.56, 	0.48, 0.46 );
	 	glVertex3f(  0.34,  0.48, 0.46 );
	 	glVertex3f(  0.34,  0.48, 0.6 );
	 	glVertex3f(  0.56, 	0.48, 0.6 );
	glEnd();


	//Parede esquerda - andar 4 - torre direita
	glBegin(GL_POLYGON);
	 	glVertex3f(  0.56,  0.18, 0.46 );
	 	glVertex3f(  0.34,  0.18, 0.46 );
	 	glVertex3f(  0.34,  0.18, 0.6 );
	 	glVertex3f(  0.56,  0.18, 0.6 );
	glEnd();
